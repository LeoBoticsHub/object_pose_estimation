...
A __PCD_Obj_Combined__ object provides different functions to capture object point clouds from RGBD cameras, retrieves the pcd combined of the masked object and the centroid of the fitted plane of the upper surface of the objects (in general boxes).
